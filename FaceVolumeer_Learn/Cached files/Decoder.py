...
import const
from const import ShapeParamDimensionSize, AlbedoParamDimensionSize, BATCH_SIZE, RANDOM_SEED
...
class Decoder(Model):
    ...
    def ConfigureModel(self) -> Model:
        ...
        reshape = Reshape(target_shape=(const.TEXTURE_SIZE[0] // 32, const.TEXTURE_SIZE[1] // 32, 320),
        ...
        bn_52 = BatchNormalization(name=self.LayerNamePrefix + "_BN52")(conv_52)
        ...
        conv_51 = Conv2DTranspose(filters=256,
                                  ...
                                  kernel_initializer = RandomNormal(mean = 0.0, stddev = 2e-02, seed = RANDOM_SEED),
                                  bias_initializer = Zeros())(relu_52)
        #bn_51 = BatchNormalization(name=self.LayerNamePrefix + "_BN51")(conv_51)
        relu_51 = LeakyReLU()(conv_51)
        ...
        #bn_43 = BatchNormalization(name=self.LayerNamePrefix + "_BN43")(conv_43)
        ...
        #bn_41 = BatchNormalization(name=self.LayerNamePrefix + "_BN41")(conv_41)
        ...
        #bn_33 = BatchNormalization(name=self.LayerNamePrefix + "_BN33")(conv_33)
        relu_33 = LeakyReLU()(conv_33)
        ...
        #bn_31 = BatchNormalization(name=self.LayerNamePrefix + "_BN31")(conv_31)
        relu_31 = LeakyReLU()(conv_31)
        ...
        #bn_23 = BatchNormalization(name=self.LayerNamePrefix + "_BN23")(conv_23)
        relu_23 = LeakyReLU()(conv_23)
        ...
        #bn_13 = BatchNormalization(name=self.LayerNamePrefix + "_BN13")(conv_13)
        relu_13 = LeakyReLU()(conv_13)
        ...
        bn_12 = BatchNormalization(name=self.LayerNamePrefix + "_BN12")(conv_12)
        ...
        conv_11 = Conv2DTranspose(filters=3,
                                  ...
                                  kernel_initializer = RandomNormal(mean = 0.0, stddev = 1e-02, seed = RANDOM_SEED),
                                  bias_initializer = Zeros())(relu_12)
