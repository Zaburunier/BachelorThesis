...
from const import ShapeParamDimensionSize, AlbedoParamDimensionSize, ProjectionParamDimensionSize, \
...
class Encoder(Model):
    ...
    def ConfigureModel(self):
        ...
        bn_11 = BatchNormalization(name="E_BN11")(conv_11)
        ...
        #bn_21 = BatchNormalization(name="E_BN21")(conv_21)
        relu_21 = LeakyReLU()(conv_21)
        ...
        conv_22 = Conv2D(filters=64,
                         ...
                         name="E_Conv22",
                         kernel_initializer = RandomNormal(mean = 0.0, stddev = 1e-03),
                         bias_initializer = Zeros())(relu_21)

        #bn_22 = BatchNormalization(name="E_BN22")(conv_22)
        relu_22 = LeakyReLU()(conv_22)
        ...
        #bn_23 = BatchNormalization(name="E_BN23")(conv_23)
        ...
        #bn_31 = BatchNormalization(name="E_BN31")(conv_31)
        ...
        #bn_33 = BatchNormalization(name="E_BN33")(conv_33)
        ...
        bn_51 = BatchNormalization(name="E_BN51")(conv_51)
        ...
        projection_output = Dense(ProjectionParamDimensionSize, name="E_ProjFC",
                                  ...
                                  bias_initializer = Zeros(), activation = "tanh") (projection_light_flatten)
